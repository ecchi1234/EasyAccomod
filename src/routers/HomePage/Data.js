...
export const homeObjTwo = {
  ...
  lightText: false,
  lightTextDesc: false,
  buttonLabel: "Đăng ký làm chủ trọ",
  description:
    "Bạn có thể đăng tin về nhà trọ của mình để tiếp cận được nhiều khách hàng hơn. Chúng tôi cũng cung cấp nhiều dịch vụ khác đi kèm để bài đăng của bạn được nổi bật hơn.",
  headline: "Thông tin nhanh chóng",
  topLine: "Easy Accommodation Agency",
  start: "true",
