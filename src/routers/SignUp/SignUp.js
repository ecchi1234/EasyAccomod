        ...
        <SignUpSection>
          <SignUpForm>
            <SignUpFormGroup>
              ...
              <FormTextInput type="text" {...lastname} onBlur={() => {
            ...
            <SignUpFormGroup>
              ...
              <FormTextInput type="text" {...firstname} onBlur={() => {
            ...
            <SignUpFormGroup>
              ...
              <FormTextInput type="text" {...username} onBlur={() => {
            ...
            <SignUpFormGroup>
              ...
              <FormTextInput type="password" {...password} onBlur={() => {
            ...
            <SignUpFormGroup>
              ...
              <FormTextInput type="password" {...confirmpass} onBlur={() => {
            ...
            <SignUpFormGroup>
              ...
              <FormTextInput type="text" {...email} onBlur={() => {
            ...
            <SignUpFormGroup>
              ...
              <FormTextInput type="text" {...phone} onBlur={() => {
            ...
            <SignUpFormGroup>
              ...
              <FormTextInput type="address" {...address} onBlur={() => {
            ...
            <SignUpFormGroup>
              ...
              <FormTextInput type="text" {...identitynumber} onBlur={() => {
